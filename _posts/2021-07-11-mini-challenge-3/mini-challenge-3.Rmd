...
q2_accident_m <- q2_meaningful %>%
  filter(str_detect(message,"shooting|stanoff|hostage|swat|hegotiation|fight|arrest|hit|van| drive|bicyclist|accident|incident|bike|L829|pursuit|gun|shot|kill|dead|yelling|screaming|negotiatingnegotiator|caught|over|end"))
