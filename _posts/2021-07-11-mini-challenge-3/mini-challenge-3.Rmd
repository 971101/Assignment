...
q2_rally_tidy%>%
  ...
  ggplot(aes(x = time)) +
  geom_histogram(fill = "#99CCFF",color ="#FFFFFF")+
...
q2_rally_tidy%>%
  ...
  ggplot(aes(x = time)) +
  geom_histogram(fill = "#6699CC",color ="#FFFFFF")+
  coord_cartesian(xlim = c(61200,77460))+
  theme(panel.grid=element_blank(),axis.text.x= element_text(angle=60, hjust= 1))+
    labs(y ="sylvia|marek")
...
q2_fire_tidy%>%
  ...
  ggplot(aes(x = time)) +
  geom_histogram(fill = "#FFCCCC",color ="#FFFFFF")+
  coord_cartesian(xlim = c(61200,77460))+
  theme(panel.grid=element_blank(),axis.text.x= element_text(angle=60, hjust= 1))+
    labs(y = NULL)
...
q2_fire_tidy%>%
  ...
  ggplot(aes(x = time)) +
  geom_histogram(fill = "#FF99CC",color ="#FFFFFF")+
  coord_cartesian(xlim = c(61200,77460))+
  theme(panel.grid=element_blank(),axis.text.x= element_text(angle=60, hjust= 1))+
  labs(y =NULL)
...
q2_fire_tidy%>%
  ...
  ggplot(aes(x = time)) +
  geom_histogram(fill = "#CC6699",color ="#FFFFFF")+
  coord_cartesian(xlim = c(61200,77460))+
  theme(panel.grid=element_blank(),axis.text.x= element_text(angle=60, hjust= 1))+
  labs(y = "control")
...
q2_fire_tidy%>%
  ...
  ggplot(aes(x = time)) +
  geom_histogram(fill = "#993366",color ="#FFFFFF")+
  coord_cartesian(xlim = c(61200,77460))+
  theme(panel.grid=element_blank(),axis.text.x= element_text(angle=60, hjust= 1))+
  labs(y =NULL)
```
