...
```{r}
p <- q2_rally_tidy%>%
  filter(str_detect(word,"pokrally|pok|rally|abila |city|park|stand|sylvia|marek|audrey|mcConnell|newman|professor|lorenzo|di|stefano|lucio|jakab|viktor-e|viktor-e")) %>%
  ggplot(aes(x = time)) +
