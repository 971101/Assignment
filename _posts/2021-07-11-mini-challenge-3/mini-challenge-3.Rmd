...
DT::datatable(df,filter = 'top',
              extensions = 'Buttons',
              options = list(autoWidth = TRUE, columnDefs = list(list(width = '400px', 
                                                                      targets = c(4))),
                             dom='Bfrtip',
...
Calculate the <font color = blue>*bind_tf_idf()*</font> to find the important words for the content of each document.
...
* Meaningless: The graoh shows that for meaningless message, company event slogans(like "nobanks").
